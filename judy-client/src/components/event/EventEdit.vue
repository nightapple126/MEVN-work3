    ...
    <div class="form-event">
     ...
     <Form ref="formValidate" :model="eventForm" :rules="rules" :label-width="80">
         <div class="left-side">
            ...
            <FormItem v-if="eventForm.location" label="Location" prop="location">
                <GoogleMap placeholder="Event location .." :pos="eventForm.location" edit="true" @location="getInput"></GoogleMap>
            </FormItem>
         </div>
...
export default {
        ...
        if (valid) {
          ...
          if (this.eventForm.event_image) {
            console.log('Valid form!!');
             try {
            await Event.put(this.eventForm._id, this.eventForm)
  ...
  async beforeCreate() {
    ...
    try {
      this.eventForm = (await Event.getOneForGuest(
