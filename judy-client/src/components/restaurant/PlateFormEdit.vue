    ...
    export default {
                ...
                this.$refs[name].validate((valid) => {
                    if (valid) {
                        if(this.formValidate.plate_photo) {
                            ...
                            Food.put(this.formValidate, this.id)
                            this.$Message.success('plate modified!')
                            this.$router.push({ name:'/staff/restaurant/plate/all' })
                        }else {
                            this.$Message.error('please upload plate photo!')
                        }
                    } else {
        ...
        async mounted() {
            try{
                ...
                const plate = (await Food.getOne(this.id)).data.plate
                this.formValidate = plate;
                this.formValidate.basic_ingredient = this.formValidate.basic_ingredient.join(',');
